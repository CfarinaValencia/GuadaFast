$(document).ready(function () {
    ...
    function llenarTablaCarrito(response){
        ...
        response.forEach(element => {
            ...
            $("#tablaCarrito tbody").append(
                `
                <tr>
                    <td><img src="${element['foto']}" class="img-size-50"/></td>
            ...
            $("#tablaPasarela tbody").append(
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="id[]" value="${precio.toFixed(2)}">
                    </td>
                    <td>$${precio.toFixed(2)}</td>
                    <td>$${totalProd.toFixed(2)}</td>
                <tr>
    ...
    $("#agregarCarrito").click(function (e) { 
        ...
        $.ajax({
            ...
            data: {"id":id,"nombre":nombre,"foto":foto,"cantidad":cantidad,"precio":precio},
            dataType: "json",
            success: function (response) {
                llenaCarrito(response);
    ...
    function llenaCarrito(response){
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                `
                <a href="cliente.php?modulo=detalleProducto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="${element['foto']}" class="img-size-50 mr-3 img-circle">
        ...
        $("#listaCarrito").append(
            `
            <a href="cliente.php?modulo=carrito" class="dropdown-item dropdown-footer text-primary">
                Ver carrito 
