...
<form action="cliente.php?modulo=factura" method="post" id="payment-form">
    ...
    <div class="form-row">
        <label for="card-element">
            Ingrese los datos de tu tarjeta
        </label>
    ...
    <div class="mt-3">
        <a class="btn btn-warning" href="cliente.php?modulo=envio" role="button">Ir a envio</a> -->
