	...
	if(!isset($_SESSION['email'])){
		echo'
			<script>
				...
				window.location= "portalADMIN.php";
			</script>
  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        <!-- Messages Dropdown Menu -->
          ...
          <a class="nav-link text-danger" href="panel.php?modulo=&sesion=cerrar" title="Cerrar sesion" >
            <i class="fas fa-door-closed    ">SALIR</i>
          </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">GUADAÑEROS</span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="panel.php?modulo=productos" class="nav-link <?php echo ($modulo=="productos"
                   || $modulo=="crearProducto" || $modulo=="editarProducto" )?" active ":" "; ?>">
                    <i class="fa fa-shopping-bag nav-icon" aria-hidden="true"></i>
                    <p>Productos</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="panel.php?modulo=contactos" class="nav-link <?php echo ($modulo=="contactos" )?" active ":" "; ?>">
...
<script>
  $(document).ready(function () {
    $(".borrar").click(function (e) { 
      e.preventDefault();
      var res=confirm("Realmente quieres (borrar) esta seleccion?");
      if(res==true){
